package com.yang.redisdemo.util;
...
import com.yang.redisdemo.config.TencentSMSConfig;
...
public class SMSUtils {
    ...
    public boolean sendTencentSMS(String Phone,String Code,String Time) throws TencentCloudSDKException {
        /* 必要步骤：
